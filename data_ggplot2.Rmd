...
weather_df %>% 
  mutate(
    name = factor(name),
    name = forcats::fct_relevel(name, c("Waikiki_HA")) #change the order of them, convert them to factor. It's a data manipulation problem./ or (name, tmax), in the order of tmax.
  ) %>% 
